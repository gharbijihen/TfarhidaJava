...
public class AfficherMoyF {
    ...
    private void displayMoyens(ObservableList<Moyen_transport> moyens) {
        try {
            ...
            for (int i = fromIndex; i < toIndex; i++) {
                ...
                if (moyen.isValide()) {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/MoyenFxml/itemM.fxml"));
    ...
    void handleAjouter() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MoyenFxml/ajouterMoyen.fxml"));
    ...
    void gotodash() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MoyenFxml/adminDashbord.fxml"));
            Parent root = loader.load();
    ...
    private void openWeatherPage(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MoyenFxml/weather.fxml"));
            Parent root = loader.load();
    ...
    public void goToClient(MouseEvent event) {
        edu.esprit.controller.RouterController.navigate("/MoyenFxml/afficherMoyenB.fxml");

    }

    public void goToLogn(MouseEvent event) {
        edu.esprit.controller.RouterController.navigate("/fxml/login.fxml");
