...
import edu.esprit.entites.QRcodeActivite;
...
// Récupérer le logement associé à cette carte
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ActiviteFxml/QRCode.fxml"));
            Stage stage = new Stage();
            stage.setScene(new Scene(loader.load()));

            // Obtenez le contrôleur des détails du logement
            QrCodeActivite QrController = loader.getController();
  ...
  public void initialize() {
    ...
    void afficherDetails(ActionEvent event) {
        ...
        if (activite != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ActiviteFxml/show.fxml"));
    ...
    private void openMap(String location) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ActiviteFxml/Map.fxml"));
            Parent root = loader.load();
