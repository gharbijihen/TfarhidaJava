...
public class AfficherRestaurantB {
    ...
    void allerversstat(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/FXMLRes/stat.fxml"));
    ...
    public void goToAjoutPlat(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXMLRes/plataffb.fxml"));
    ...
    private void openModifierRestaurantPage(Restaurant restaurant) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXMLRes/updateRestaurant.fxml"));
            Parent root = loader.load();
    ...
    @FXML
    public void AjouterRestaurant(ActionEvent  event) {
        try {


            // Charger le fichier FXML de la nouvelle page
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXMLRes/RestaurantAjouter.fxml"));
            Parent root = loader.load();
    ...
    public void goToafficherNavBar(ActionEvent actionEvent) {
