...
public class Commande {
    ...
    private Logement doa_com_id;
    private User user_id;

    private float ins_value;


    public Commande(float montant, Date date_effet, Date date_exp, ArrayList doa_full, Logement doa_com_id, User user_id, float ins_value) {
    ...
    public Commande(int id, float montant, Date date_effet, Date date_exp, ArrayList doa_full, Logement doa_com_id, User user_id, float ins_value) {
        this.id = id;
        this.montant = montant;
        this.date_effet = date_effet;
        this.date_exp = date_exp;
    ...
    public Logement getDoa_com_id() {
        return doa_com_id;
    }

    public void setDoa_com_id(Logement doa_com_id) {
        this.doa_com_id = doa_com_id;
    }
